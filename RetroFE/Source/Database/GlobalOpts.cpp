...
const global_options::options_entry global_options::s_option_entries[] =
{
    ...
    { OPTION_LOG,                     "NONE",      global_options::option_type::STRING,   "Set logging level, any combo of ERROR,INFO,NOTICE,WARNING,DEBUG,FILECACHE or ALL or NONE. Use - to invert logging (ALL, -INFO)" },
    ...
    { OPTION_SDLRENDERDRIVER,          "", global_options::option_type::STRING,   "Set SDL3 renderer (empty selects the platform default; direct3d11, direct3d12, opengl, opengles2, metal, gpu, software)" },
