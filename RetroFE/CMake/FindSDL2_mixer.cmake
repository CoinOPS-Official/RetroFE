...
# configure. Discard missing cached results so find_path/find_library rerun.
if(SDL2_MIXER_INCLUDE_DIR AND NOT EXISTS "${SDL2_MIXER_INCLUDE_DIR}/SDL_mixer.h")
  unset(SDL2_MIXER_INCLUDE_DIR CACHE)
endif()
if(SDL2_MIXER_LIBRARY AND NOT EXISTS "${SDL2_MIXER_LIBRARY}")
